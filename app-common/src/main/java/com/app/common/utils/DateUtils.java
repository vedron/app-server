...
public class DateUtils {
	...
	public static final String ORDER_YYYY_MM_DD_HH_MM_SS_SSS = "yyyyMMddHHmmssSSS";
	...
	public static Date toDate(String date, String format) throws ParseException {
		if (date == null || date == "")
			throw new NullPointerException("input date is null or empty!");
	...
	public static long getTodayLeftMil() {
